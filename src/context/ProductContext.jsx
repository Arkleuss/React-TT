...
export const ProductsProvider = ({ children }) => {
    ...
    useEffect(() => {
        ...
        try {
            const respuesta = await fetch('https://68d9b97290a75154f0db05e8.mockapi.io/api/productos');
    ...
    const editarProducto = async (productoActualizado) => {
        try {
        const respuesta = await fetch(`https://68d9b97290a75154f0db05e8.mockapi.io/api/productos/${productoActualizado.id}`, {
            method: 'PUT',
            headers: { 'Content-Type': 'application/json' },
